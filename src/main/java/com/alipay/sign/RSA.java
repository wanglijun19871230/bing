...
//            PrivateKey priKey= keyFactory.generatePrivate(rsaPrivKeySpec);  
	 ...
	 * @return 签名值
	 */
	public static String signWithPCKS1(String content, byte[] privateKey, String input_charset)
	{
	    try 
	    {
//            RSAPrivateKeyStructure asn1PrivKey = new RSAPrivateKeyStructure((ASN1Sequence) ASN1Sequence.fromByteArray(privateKey));  
	...
	*/
	public static boolean verify(String content, String sign, String ali_public_key, String input_charset)
	{
		try 
		{
			...
			signature.update( content.getBytes(input_charset) );
			byte[] b2verify = Base64.decode(sign);
			if(b2verify==null) {
                return false;
            }
			
			boolean bverify = signature.verify( b2verify );
			return bverify;
